              ...
              <div className="w-full mx-auto max-w-2xl py-8 sm:py-12 text-center">
                ...
                <div className="mt-8">
                  <div className="relative group inline-block">
                    ...
                    <a href={TALLY_URL} target="_blank" rel="noopener noreferrer" className="relative z-10 px-6 py-3 text-sm font-semibold text-black bg-gradient-to-br from-gray-100 to-gray-300 rounded-full hover:from-gray-200 hover:to-gray-400 transition-all duration-200">Apply for sponsorship</a>
                  </div>
                </div>
              </div>
            </div>
            ...
            {activeTabIndex === 2 && (
              <div className="text-white/80 space-y-3 max-w-xl mx-auto">
                ...
                <ul className="space-y-3">
                  <li className="flex items-start gap-3">
                    <span className="text-white/50 mt-1">•</span>
                    <span className="leading-relaxed">Lead the room. You can create with us the story around your presence</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-white/50 mt-1">•</span>
